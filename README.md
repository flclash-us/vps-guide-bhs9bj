[English] One-click VPS performance test: CPU, memory, disk IO, network speed.

## Usage

wget -qO- https://raw.githubusercontent.com/flclash-us/vps-guide-bhs9bj/main/benchmark.sh | bash
